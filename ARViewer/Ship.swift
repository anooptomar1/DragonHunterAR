...
class Ship: SCNNode {
    override init() {
        ...
        if let wolfScene = SCNScene(named: "dragon.scnassets/dragon.dae") {
            
            let wolfNode = wolfScene.rootNode.childNode(withName: "dragon", recursively: true)
            wolfNode?.scale = SCNVector3Make(0.0001, 0.0001, 0.0001)
